...
def Synthetic_Table():#(Date_1_year,Date_1_quarter,Date_2_year,Date_2_quarter,IndexCode_temp):
    #Hardcoded 
    query = request.args
    Date_1_year = "2018"#query.get("date_yr1")
    Date_1_quarter = 1 #query.get("date_qrt1")

    Date_2_year = "2018"# query.get("date_yr2")
    Date_2_quarter = 4 #query.get("date_qrt2")

    IndexCode_temp = "TOPI" #query.get("index_code")
    #---------------------
